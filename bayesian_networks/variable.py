...
class Variable(object):
    ...
    def __init__(self, name: str, assignments: tuple[str, ...],
        ...
        self.probability_table: dict[tuple[str, ...],
                                     tuple[float, ...]] = probability_table
    ...
    def calculate_marginal_probability(self):
        ...
        for assignment_str in self.assignments:
            prob = self.get_conditional_probability(assignment_str, {})
            index = self.assignments[assignment_str]
            self.marginal_probabilities[index] = prob
